      ...
      <div class="col s12 m4 l3 blue-grey padding-top" id="left-side">
        <div class="valign-wrapper">
          <div class="col" layout="row">
            <img src="https://secure.gravatar.com/avatar/1e3c57384534f3e7b13ae465b5a1db0a" alt="Jefferson Frade" class="circle">
          </div>
          <div>
            <p>
              <span class="grey-text text-lighten-2">Jefferson Frade</span><br>
